...
do
	...
	if [[ "$condition" =~ [[:alnum:]] ]]; then
		...
		item_file_array=( `func_relative2 "$cmd1" "$cmd2" "$cmd3" "" "file"` )
		item_dir_array=( `func_relative2 "$cmd1" "$cmd2" "$cmd3" "" "dir"` )
		item_parent_file_array=( `func_relative2 "$cmd1" "$cmd2" "$cmd3" ".." "file"` )
		item_parent_dir_array=( `func_relative2 "$cmd1" "$cmd2" "$cmd3" ".." "dir"` )
